...
export interface DeleteExperienceUseCaseInput {
  userId: string;
  experienceId: string;
...
export class DeleteExperienceUseCase
  implements UseCase<DeleteExperienceUseCaseInput, void>
{
  constructor(
  ...
  async execute(input: DeleteExperienceUseCaseInput): Promise<void> {
